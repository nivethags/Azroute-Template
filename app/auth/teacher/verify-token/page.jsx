    ...
    const verifyToken = async () => {
      try {
        ...
        const response = await fetch(
          `/api/auth/teacher/verify-token?token=${encodeURIComponent(token)}`,
          {
            method: 'GET',
            headers: {
  ...
  return (
    <Card className="w-full max-w-lg">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl text-center">Teacher Email Verification</CardTitle>
          ...
          <div className="space-y-4">
            <Alert className="bg-green-50 border-green-200">
              <AlertDescription className="text-green-700">
                Your teacher account email has been verified successfully! You will be redirected to the login page in {redirectCountdown} seconds...
              </AlertDescription>
            </Alert>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-center text-sm text-gray-600">
                ...
                {' '}and request one from your account. If you continue to experience issues, please contact our support team.
              </div>
            </div>
          </div>
        )}
